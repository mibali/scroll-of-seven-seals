...
class MultiplayerManager {
    ...
    async checkForGameWinner(gameId, winningTeamId, winningTeamData, completionTime) {
        try {
            ...
            if (completedTeams.length === 1) {
                ...
                await this.broadcastWinnerAnnouncement(gameId, winningTeamData, completionTime, finalScore);
            }
    ...
    // Broadcast winner announcement to all players
    async broadcastWinnerAnnouncement(gameId, winningTeam, completionTime, score) {
        try {
