...
class GameController {
    ...
    showWinnerModal(announcement, winner) {
        // Remove any existing winner modal
        ...
        const modalHtml = `
            <div id="winnerModal" class="modal-overlay">
                <div class="modal-content winner-modal">
                    ...
                    <div class="modal-buttons">
                        <button class="btn" onclick="gameController.showFinalLeaderboard()">View Final Results</button>
                        <button class="btn btn-secondary" onclick="gameController.returnToMenu()">Return to Menu</button>
                    </div>
                </div>
            </div>
        `;
        ...
        // Auto-hide the modal after 30 seconds if still showing
        setTimeout(() => {
    ...
    lockGameInputs() {
        ...
        // Disable any puzzle inputs
        const puzzleInputs = document.querySelectorAll('.puzzle-modal input, .puzzle-modal button:not(.close-btn)');
    ...
    showFinalLeaderboard() {
        ...
        window.LeaderboardManager.showFinalResults(this.gameState.gameId);
    }
